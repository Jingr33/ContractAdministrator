...
namespace Contract_Administrator.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalIdNum = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractAdmin = table.Column<int>(type: "int", nullable: false),
                    ...
                    AdviserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractAdvisers", x => new { x.ContractId, x.AdviserId });
                    table.ForeignKey(
                        name: "FK_ContractAdvisers_Adviser_AdviserId",
                        column: x => x.AdviserId,
                        principalTable: "Adviser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractAdvisers_Contract_ContractId",
